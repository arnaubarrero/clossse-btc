    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow-md">
            ...
            <div className="gap-4 mb-4">
                <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Ingresa al menos 4 caracteres" className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#008080] flex-grow" />
                <button onClick={handleSearch} disabled={searchQuery.length < 4} className="px-8 py-2 bg-[#008080] hover:bg-[#006666] text-white rounded-lg transition-colors duration-200 font-semibold disabled:bg-gray-300 disabled:cursor-not-allowed" >
                    Buscar
                </button>
            </div>
